...
import {
  PopulationCompositionPerYearResponseFromJSON,
  PopulationCompositionPerYearResponseToJSON,
  PrefecturesResponseFromJSON,
  PrefecturesResponseToJSON,
} from '../models/index';
...
export class DefaultApi extends runtime.BaseAPI {
   ...
   */
  async apiV1PopulationCompositionPerYearGetRaw(
    requestParameters: ApiV1PopulationCompositionPerYearGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PopulationCompositionPerYearResponse>> {
    if (requestParameters['prefCode'] == null) {
      throw new runtime.RequiredError(
        'prefCode',
        'Required parameter "prefCode" was null or undefined when calling apiV1PopulationCompositionPerYearGet().',
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PopulationCompositionPerYearResponseFromJSON(jsonValue),
    );
  }
   ...
   * 地域単位、年単位の年齢構成のデータを返します。
   */
  async apiV1PopulationCompositionPerYearGet(
    requestParameters: ApiV1PopulationCompositionPerYearGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PopulationCompositionPerYearResponse> {
    const response = await this.apiV1PopulationCompositionPerYearGetRaw(
      requestParameters,
      initOverrides,
    );
   ...
   * 都道府県に関する一覧データを返します。
   */
  async apiV1PrefecturesGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PrefecturesResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PrefecturesResponseFromJSON(jsonValue),
    );
  }
   ...
   * 都道府県に関する一覧データを返します。
   */
  async apiV1PrefecturesGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PrefecturesResponse> {
    const response = await this.apiV1PrefecturesGetRaw(initOverrides);
    return await response.value();
  }
}
