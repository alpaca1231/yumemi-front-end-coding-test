...
/**
 * Check if a given object implements the PrefecturesResponse interface.
 */
export function instanceOfPrefecturesResponse(
  value: object,
): value is PrefecturesResponse {
  if (!('message' in value) || value['message'] === undefined) return false;
  if (!('result' in value) || value['result'] === undefined) return false;
  return true;
}

export function PrefecturesResponseFromJSON(json: any): PrefecturesResponse {
  return PrefecturesResponseFromJSONTyped(json, false);
}

export function PrefecturesResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    result: (json['result'] as Array<any>).map(PrefectureFromJSON),
  };
}

export function PrefecturesResponseToJSON(json: any): PrefecturesResponse {
  return PrefecturesResponseToJSONTyped(json, false);
}

export function PrefecturesResponseToJSONTyped(
  value?: PrefecturesResponse | null,
  ...
  return {
    ...
    result: (value['result'] as Array<any>).map(PrefectureToJSON),
  };
}
